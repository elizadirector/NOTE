...
'
    ...
    With ActiveSheet
        ...
        With ActiveSheet.ListObjects.Add(SourceType:=0, Source:= _
            ...
            , Destination:=Range("$J$2")).QueryTable
            .CommandType = xlCmdSql
        ...
        With ActiveSheet.ListObjects.Add(SourceType:=0, Source:= _
            ...
            , Destination:=Range("$R$2")).QueryTable
            .CommandType = xlCmdSql
        ...
        With ActiveSheet.ListObjects.Add(SourceType:=0, Source:= _
            ...
            , Destination:=Range("$V$2")).QueryTable
            .CommandType = xlCmdSql
        ...
        With ActiveSheet.ListObjects.Add(SourceType:=0, Source:= _
            ...
            , Destination:=Range("$Z$2")).QueryTable
            .CommandType = xlCmdSql
        ...
        With ActiveSheet.ListObjects.Add(SourceType:=0, Source:= _
            ...
            , Destination:=Range("$AL$2")).QueryTable
            .CommandType = xlCmdSql
        ...
        .Names(Table_6).Delete
        .Names(Table_7).Delete
        '.Names(Table_6).Delete
        '.Names(Table_7).Delete
